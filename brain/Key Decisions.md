...
- **llm-wiki を TECS 仕様書作成の主要ツールに採用（2026-04-24）** — 87 HTML ソースから wiki ページを自動生成する pipeline を確立。NotebookLM / 手動作成より自動化・再現性を優先する判断。証跡: git commit around `87c59c2`, [[03-Resources/my-topic/CLAUDE|TECS Wiki]]
