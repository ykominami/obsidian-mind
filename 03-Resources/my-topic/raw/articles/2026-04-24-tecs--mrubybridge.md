...
date: 2026-04-24
source-type: article
source-url: E:\Crepo\github-toppers\tecs-docs\docs\_build\html\tecs\mrubyBridge.html
title: <no title>
compiled: true
tags: [tecs, toppers, documentation]
description: "TECS ドキュメント: <no title>"
---
...
- 
- 
- > |       BridgeCell         |--------------|>   TargetCell     ||cTECS    eTest|                   |mruby クラス：            |              |                   |TECS::TSignatureBridge  |              |                   |
+--------------------------+              +-------------------+
...
typedef型          上記のスカラー型、構造体型、ポインタ型の typedefされた型を扱うことができる。元の型として扱われる。
...
することができます。
ex)generate( MrubyBridgePlugin, sSignature,
"ignoreUnsigned=true, "
"include='func1,func2', "
"include='func3,func4', "
...
namespace nMruby {celltype SSignature{
...
cell nMruby::tsSignature BridgeCell {cTECS = Cell.eEnt;
VMname = "VM2";
