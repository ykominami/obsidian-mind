...
date: 2026-04-24
source-type: article
source-url: E:\Crepo\github-toppers\tecs-docs\docs\_build\html\tecs\CDLref_namespace.html
title: ネームスペース
compiled: false
tags: [tecs, toppers, documentation]
description: "TECS ドキュメント: ネームスペース"
---
...
```
namespacenNS{signaturesSig{voidfunc(void);};[active]celltypetCelltype{entrysSigeEntry;};};cellnNS::tCelltypeCell{};
```
