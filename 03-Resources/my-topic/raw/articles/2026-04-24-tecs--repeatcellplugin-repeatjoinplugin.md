...
date: 2026-04-24
source-type: article
source-url: E:\Crepo\github-toppers\tecs-docs\docs\_build\html\tecs\RepeatCellPlugin+RepeatJoinPlugin.html
title: <no title>
compiled: true
...
- 
セル名の末尾は1桁以上の数字終わっている必要があります。末尾の数字
はカウント番号に置き換えられます。数字はカウントアップされます。

- 
右辺のセル名が1桁以上の数字で終わっている場合、数字はカウントアッ
プされます。

- 
右辺の受け口が配列の場合、添数はカウントアップされます。

- 
右辺が単一の識別子で、末尾が1桁以上の数字で終わっている場合、数字
はカウントアップされます。
