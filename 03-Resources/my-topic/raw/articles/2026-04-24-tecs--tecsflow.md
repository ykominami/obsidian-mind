...
title: tecsflow コマンドリファレンス
compiled: true
tags: [tecs, toppers, documentation]
description: "TECS ドキュメント: tecsflow コマンドリファレンス"
---
...
$(GEN_DIR)/tecsgen.rbdmp :$(TECS_TARGET)tcflow :$(TECS_TARGET)maketcflow_exec

tcflow_exec :$(GEN_DIR)/tcflow.rbdmp$(GEN_DIR)/tcflow.rbdmp :$(CELLTYPE_SRCS)$(PLUGIN_CELLTYPE_SRCS)tcflow-g$(GEN_DIR)-c'$(CC) -E -DTECSFLOW $(CFLAGS) -I ./'$^
...
```
[activecell]::AVR_CyclicAVR(../../tecs_lib/mindstorms_nxt/target_lib_inst.cdl46)ciBody.main=>AVR_AVRBody.eiCyclicBody.main(gen/tmp_tAVRBody.c482)nxt_avr_updateBody:printed
```
...
```
---unreferencedentryfunctions---[unreferencedentryfunction]::ASPKernel.eKernel.sleep(../../tecs_kernel/tKernel_inline.h56)slp_tsk:[FunctionOutofTECS,notdefined]
```
...
```
---unreferencedCfunctions---[FunctionOutofTECS,unreferenced]at91sam7s_putc(../../target/mindstorms_nxt_gcc/at91sam7s.h667)CallingFunction:sil_rew_mem(../../target/mindstorms_nxt_gcc/at91sam7s.h667)sil_wrw_mem:printed
```
