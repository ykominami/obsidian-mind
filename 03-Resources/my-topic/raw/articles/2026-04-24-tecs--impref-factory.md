...
date: 2026-04-24
source-type: article
source-url: E:\Crepo\github-toppers\tecs-docs\docs\_build\html\tecs\IMPref_factory.html
title: ファクトリ
compiled: true
tags: [tecs, toppers, documentation]
description: "TECS ドキュメント: ファクトリ"
---
...
```
celltypetTask{attr{IDid=C_EXP("TASKID_$id$");VP_INTexinf;[omit]ATRtskatr;[omit]PRIitskpri;[omit]SIZEstksize=4096;};factory{write("tecsgen.cfg","CRE_TSK(%s,{%s,&$id$_CB,tTask_start_task,%s,%s,NULL});",id,tskatr,itskpri,stksize);};};
```
...
```
celltypetCelltype{FACTORY{write("$ct$_factory.h","#include \"kernel_cfg.h\"");};};
```
