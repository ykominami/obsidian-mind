...
date: 2026-04-24
source-type: article
source-url: E:\Crepo\github-toppers\tecs-docs\docs\_build\html\tecs\CDLref_preface.html
title: 前置部
compiled: false
tags: [tecs, toppers, documentation]
description: "TECS ドキュメント: 前置部"
---
...
```
typedefdouble64_tLengthM;typedefdouble64_tWeightKg;typedefint64_tsize64_t;
```
